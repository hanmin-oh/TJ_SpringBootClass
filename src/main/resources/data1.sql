-- article 더미 데이터
INSERT INTO article(id, title, content) VALUES(1, '이순신' , '명량해전');
INSERT INTO article(id, title, content) VALUES(2, '강감찬' , '귀주대첩');
INSERT INTO article(id, title, content) VALUES(3, '을지문덕' , '살수대첩');
